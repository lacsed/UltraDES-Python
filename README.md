<picture>
  <source media="(prefers-color-scheme: dark)" srcset="imgs/ultrades_python_dark.png">
  <source media="(prefers-color-scheme: light)" srcset="imgs/ultrades_python_light.png">
